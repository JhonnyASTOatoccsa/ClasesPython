...
et=Label(ventana,text='primer numero').grid(row=0,column=0)
num1=Entry()
num1.grid(row=0,column=1)

et=Label(ventana,text='primer numero').grid(row=1,column=0)
num2=Entry()
num2.grid(row=1,column=1)

et=Label(ventana,text='primer numero').grid(row=2,column=0)
result=Entry()
