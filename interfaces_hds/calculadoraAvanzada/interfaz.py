...
class InterfazCalculadora(Tk):
    ...
    def construir_widget(self):
        ...
        self.operacion_label=Label(self,text="",font=("Arial",16),
        fg=cons.COLOR_TEXTO_NEGRO,bg=cons.COLOR_FONDO_NEGRO,justify="right")
        self.operacion_label.grid(row=0,column=3,padx=10,pady=10)

       
        self.caja_operaciones=Entry(self,width=12,
        font=("Arial",40),bd=0,fg=cons.COLOR_TEXTO_NEGRO,
        bg=cons.COLOR_FONDO_NEGRO,justify="right")
        ...
        for boton in botones:
            if boton in ["=","*","/","-","+","C","<","%"]:
                ...
                color_fondo=cons.COLOR_BOTON_NEGRO
                boton_font=robot_font
            if boton=="=":
                Button(self,command=lambda b=boton:enviar_boton(self,b),
                text=boton,width=11,height=2,bg=color_fondo,fg=cons.COLOR_TEXTO_NEGRO,
                relief=FLAT,font=boton_font,padx=5,pady=5,bd=0,borderwidth=0,
                highlightthickness=0,overrelief="flat").grid(row=row_ini,column=col_ini,
                columnspan=2,pady=5)
                col_ini +=1
            else:
                Button(self,command=lambda b=boton:enviar_boton(self,b),text=boton,
                width=5,height=2,bg=color_fondo,fg=cons.COLOR_TEXTO_NEGRO,relief=FLAT,
                font=boton_font,padx=5,pady=5,bd=0,borderwidth=0,highlightthickness=0,
    ...
    def boton_cambio_tema(self):
        ...
        self.boton_tema=Button(self,text='Modo Oscuro \uf136',width=13,font=font_icono,
        bd=0,borderwidth=0,highlightthickness=0,relief=FLAT,
